...
Future<void> updateTransaction(int id) async {
 ...
 final Map<String, TextEditingController> controllers = {
   ...
   'Transaction Code': TextEditingController(text: transaction['transactionCode']),
   ...
   'Has Profile Pic': TextEditingController(text: transaction['hasProfilePic'].toString()),
                 ...
                 child: TextFormField(
                   ...
                   onTap: () async {
                     if (key == 'Date') {
                       ...
                       if (date != null) {
                         controllers[key]!.text = date.toString().split(' ')[0];
                       }
                     } else if (key == 'Time') {
         ...
         ElevatedButton(
           onPressed: () async {
             final updatedData = Map.fromIterables(
               controllers.keys.map((k) => k.toLowerCase().replaceAll(' ', '')),
