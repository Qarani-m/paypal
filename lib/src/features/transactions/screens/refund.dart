...
String readAboutMe() {
  ...
  return box.read('aboutme') ?? "The Original transaction was on Feb 60, 2025"; // Returns an empty string if 'aboutme' is not set
}
void writeAboutMe(String aboutMe) {
  final box = GetStorage();
  box.write('aboutme', aboutMe) ;
}
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                writeAboutMe(textController.text);
