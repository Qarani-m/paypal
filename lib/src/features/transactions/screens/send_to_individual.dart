...
class SendtoIndiviualController extends GetxController {
...
class SendToIndividual extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, String> nameAndSigns = {'GBP': '£', 'EUR': '€', 'USD': '\$', 'AUD':'A\$10'};
    Map<String, String> nameAndSignsExtended = {
      'GBP': '£',
      'EUR': '€',
      'USD': 'US\$',
      'AUD':'A\$10'
    ...
    List<String> belowShowStory = ['send_money', 'i6', 'messages'];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(
          () => Text(
            controller.showContent.value ? '' : "Money sent",
        ...
        () => Padding(
          ...
          child: controller.showContent.value
              ...
              : TheMainBody(
                  ...
                  nameAndSigns: nameAndSigns,
                  belowShowStory: belowShowStory,
                  isPaymentCompleted: isPaymentCompleted,
                  sameTextStyle: sameTextStyle,
                  nameAndSignsExtended: nameAndSignsExtended,
                  currency: currency,
                  howCanWeHelpIcons: howCanWeHelpIcons,
...
class TheMainBody extends StatelessWidget {
  const TheMainBody({
    super.key,
    required this.transaction,
    required this.nameAndSigns,
    required this.belowShowStory,
    required this.isPaymentCompleted,
    required this.sameTextStyle,
    required this.nameAndSignsExtended,
    required this.currency,
    required this.howCanWeHelpIcons,
    required this.howCanWeHelp,
  });

  final PaymentModel transaction;
  final Map<String, String> nameAndSigns;
  final List<String> belowShowStory;
  final bool isPaymentCompleted;
  final TextStyle sameTextStyle;
  final Map<String, String> nameAndSignsExtended;
  final String? currency;
  final List<IconData> howCanWeHelpIcons;
  final List<String> howCanWeHelp;
...
Text.rich(
  TextSpan(
    children: [
      ...
      TextSpan(
        text: nameAndSigns[transaction.currency], // Styled differently
          ...
          color: Colors.black.withOpacity(1),
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    ...
                    color: const Color.fromARGB(255, 8, 20, 8).withOpacity(1)),
              ),
            ],
          ),
        ),
          ...
          child: Row(
            ...
            children: [
              for (int i = 0; i < 3; i++) ...[
                ...
                SizedBox(
                    width:
                        i != 2 ? 50.w : 20.w), // Adjust spacing between actions
              ]
            ],
          ),
        ),
...
class ActionButton extends StatelessWidget {
  ...
  const ActionButton({
    ...
    this.onTap,
    super.key,
    required this.icon, required this.transaction,
  });
